  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">            
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增player表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="pid字段" prop="pid" width="120"></el-table-column> 
    
    <el-table-column label="name字段" prop="name" width="120"></el-table-column> 
    
    <el-table-column label="curlevel字段" prop="curlevel" width="120"></el-table-column> 
    
    <el-table-column label="exp字段" prop="exp" width="120"></el-table-column> 
    
    <el-table-column label="physicalstrength字段" prop="physicalstrength" width="120"></el-table-column> 
    
    <el-table-column label="rolemodelframe字段" prop="rolemodelframe" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updatePlayer(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
          <el-popover placement="top" width="160" v-model="scope.row.visible">
            <p>确定要删除吗？</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" type="text" @click="scope.row.visible = false">取消</el-button>
              <el-button type="primary" size="mini" @click="deletePlayer(scope.row)">确定</el-button>
            </div>
